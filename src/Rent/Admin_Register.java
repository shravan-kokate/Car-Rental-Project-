...
public class Admin_Register extends javax.swing.JFrame {
        ...
        if (pwd1.equals(pwd2)) {
            ...
            if (ans == JOptionPane.YES_OPTION) {
                try {
                    ...
                    java.sql.Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3307/rentcar", "root",
                            "");
            ...
            JOptionPane.showMessageDialog(this, "Passwords entered are Different !!", "Error",
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_Register.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
