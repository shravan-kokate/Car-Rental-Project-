...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3307/rentcar", "root", "");
            ...
            // pst1 = (PreparedStatement) con.prepareStatement("UPDATE login set status =
            // 'Login' WHERE (username, password) = (?, ?)");
            ...
            if (rs.next()) {
                ...
                JOptionPane.showMessageDialog(this, "Username and Password do not match", "Error",
